...
#define S32CC_ENV_SETTINGS \
	...
	"eol_invalidate_b_partition=mmc list; mmc read ${eol_bootloader_tmp_address} 0x1800 1; mw ${eol_bootloader_tmp_address} 0xdeaddead; mmc write ${eol_bootloader_tmp_address} 0x1800 1;\0" \
	"eol_flash_a_partition=mmc list; mmc write ${eol_bootloader_tmp_address} 9 0x17F0;\0" \
	"eol_flash_b_partition=mmc list; mmc write ${eol_bootloader_tmp_address} 0x1800 0x1800;\0" \
